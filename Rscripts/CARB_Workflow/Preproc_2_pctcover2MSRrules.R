...
#mask_map = rast("preprocessing/spatial180m/basin.tif")
mask_vect = as.polygons(mask_map)

# tc tree cover, sc shrub cover, hc herb cover, oc other cover
# tc_in = rast("../data/Landcover/2019/LPC_h003v009_TC_2019_V01.tif")
# sc_in = rast("../data/Landcover/2019/LPC_h003v009_SC_2019_V01.tif")
# hc_in = rast("../data/Landcover/2019/LPC_h003v009_HC_2019_V01.tif")
# oc_in = rast("../data/Landcover/2019/LPC_h003v009_OC_2019_V01.tif")
...
writeLines(text = paste0("Mean pct cover:",cover_pct_mean, "\nMedian pct cover:",cover_pct_median), "preprocessing/spatial180m/LPC_coverfrac.txt")
...
writeRaster(LPC_veg_cover_map, "preprocessing/spatial90m/LPC_veg_cover.tif", overwrite = T)
#writeRaster(LPC_veg_cover_map, "preprocessing/spatial180m/LPC_veg_cover.tif", overwrite = T)
...
writeRaster(rules_map, "preprocessing/spatial90m/rules_90m.tif", overwrite = T)
#writeRaster(rules_map, "preprocessing/spatial180m/rules_180m.tif", overwrite = T)

# ------------------------------ OUTPUT MSR RULES FILE ------------------------------
file_out = "preprocessing/rules/LPC_90m.rules"
#file_out = "preprocessing/rules/LPC_180m.rules"
...
if (plots) {
  # PLOTS for report
  mean_cover = c(tc$LPC_h003v008_TC_2019_V01_1, sc$LPC_h003v008_SC_2019_V01_1, hc$LPC_h003v008_HC_2019_V01_1, oc$LPC_h003v008_OC_2019_V01_1)
