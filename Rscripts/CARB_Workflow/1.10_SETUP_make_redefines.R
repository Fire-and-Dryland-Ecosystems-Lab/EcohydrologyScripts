...
worldfile = "worldfiles/Ward_msr90m_thin2_init.world"
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin2_redef1_harvest.world" ,std_thin = "0.999", veg_parm_ID = 25) # harvest
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin2_redef2_remain.world" ,std_thin = "0.999", veg_parm_ID = 21) # remain
litter_vars = c("litter_cs.litr1c", "litter_ns.litr1n",	"litter_cs.litr2c", "litter_cs.litr3c", "litter_cs.litr4c", "cs.cwdc", "ns.cwdn")
build_redefine2(worldfile, out_file = "worldfiles/redefs/Ward_msr90m_thin2_redef3_litter.world" , vars = litter_vars, values = 0.0001)

# thin3 - 90% thin_harvest shrub + tree, 100% thin_remain
worldfile = "worldfiles/Ward_msr90m_thin3_init.world"
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin3_redef1_harvest.world" ,std_thin = "0.9", veg_parm_ID = c(21,25)) # harvest
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin3_redef2_remain.world" ,std_thin = "0.999", veg_parm_ID = c(21,25)) # remain

# thin4 - 50% thin_harvest shrub + tree, 100% thin_remain
worldfile = "worldfiles/Ward_msr90m_thin4_init.world"
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin4_redef1_harvest.world" ,std_thin = "0.5", veg_parm_ID = c(21,25)) # harvest
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin4_redef2_remain.world" ,std_thin = "0.999", veg_parm_ID = c(21,25)) # remain

# thin5 - 0% thin_harvest shrub + tree, 100% thin_remain
worldfile = "worldfiles/Ward_msr90m_thin5_init.world"
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin5_redef1_remain.world" ,std_thin = "0.999", veg_parm_ID = c(21,25)) # remain


# thin6 - 20% thin_harvest shrub, 90% harvest tree, 100% thin_remain
worldfile = "worldfiles/Ward_msr90m_thin6_init.world"
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin6_redef1_harvest.world" ,std_thin = "0.2", veg_parm_ID = c(25)) # harvest
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin6_redef2_harvest.world" ,std_thin = "0.9", veg_parm_ID = c(21)) # harvest
build_redefine2(worldfile, "worldfiles/redefs/Ward_msr90m_thin6_redef3_remain.world" ,std_thin = "0.999", veg_parm_ID = c(21,25)) # remain
